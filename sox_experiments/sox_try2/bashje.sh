...
sox $INFILE ${OUTFILE}_file1.wav trim $SETOFF1 5 norm -6 fade 0.1 0 0.1
# Maakt een bestand van 5 seconde puur geluid

sox $INFILE ${OUTFILE}_file2.wav trim $SETOFF2 3 lowpass 500 reverb 25 remix 1p-$PAN1 2p-$PAN2 2 norm -6 fade 0.1 0 0.1
# Maakt een bestand van 3 seconde met een lowpass, reverb en een (random) panning effect

sox $INFILE ${OUTFILE}_file3.wav trim $SETOFF3 2 overdrive 20 20 overdrive 20 20 overdrive 20 20 norm -18 fade 0.1 0 0.1
# Maakt een bestand van 2 seconde met keiharde overdrive

sox $INFILE ${OUTFILE}_file4.wav trim $SETOFF4 6 reverse fade 0.1 0 0.1 norm -6 fade 0.1 0 0.1
